 ...
 * this class implements method in other class
 * @author BAYAN
 */
public abstract class Bill implements InterfaceBill, Comparable {
   ...
   /**
    * No is static initial constant increase by one in every new order
    ...
    */
     ...
     * dessert is Array_list of dessert class 
     */
  ...
  /**
     * getter method to get object of Customers class
     * @return object
     */  
...
/**
     * setter  method to update object of Customers class
     * @param custem 
     */
...
/**
     * getter method to return ArrayList
    ...
    /**
     * setter method to update ArraList of Dessert class
     * @param des 
     */
